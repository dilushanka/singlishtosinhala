...
var specialChar= new Array()
    ...
    vowelsUni[6]='ඒ';    vowels[6]='ee';    vowelModifiersUni[6]='ේ';
    //vowelsUni[13]='ඒ';    vowels[13]='e\\)';    vowelModifiersUni[13]='ේ';
    //vowelsUni[14]='ඒ';    vowels[14]='ei';    vowelModifiersUni[14]='ේ';
    vowelsUni[7]='ඌ';    vowels[7]='uu';    vowelModifiersUni[7]='ූ';
    //vowelsUni[16]='ඌ';    vowels[16]='u\\)';    vowelModifiersUni[16]='ූ';
    vowelsUni[8]='ඖ';    vowels[8]='au';    vowelModifiersUni[8]='ෞ';
    //vowelsUni[18]='ඇ';    vowels[18]='/\a';    vowelModifiersUni[18]='ැ';
    vowelsUni[9]='ඓ';    vowels[9]='ai';    vowelModifiersUni[9]='ෛ';

    vowelsUni[10]='අ';    vowels[10]='a';    vowelModifiersUni[10]='';
    vowelsUni[11]='ඇ';    vowels[11]='A';    vowelModifiersUni[11]='ැ';
    vowelsUni[12]='ඉ';    vowels[12]='i';    vowelModifiersUni[12]='ි';
    vowelsUni[13]='එ';    vowels[13]='e';    vowelModifiersUni[13]='ෙ';
    vowelsUni[14]='උ';    vowels[14]='u';    vowelModifiersUni[14]='ු';
    vowelsUni[15]='ඔ';    vowels[15]='o';    vowelModifiersUni[15]='ො';
    nVowels=16;

    specialConsonantsUni[0]='ං'; specialConsonants[0]=/x/g;
    specialConsonantsUni[1]='ඃ'; specialConsonants[1]=/H/g;
    specialConsonantsUni[2]='ඞ'; specialConsonants[2]=/X/g;
    ...
    consonantsUni[25]='ෂ'; consonants[25]='S'; 
    ...
    consonantsUni[43]='ඣ'; consonants[43]='J';
